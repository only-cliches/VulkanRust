...
const MODEL_PATH: &'static str = "assets/monkey.obj";
...
impl App {
    ...
    pub fn new(event_loop: &EventLoop<()>) -> Result<Self> {
        ...
        let vertices = {
            ...
            let model_bytes = include_bytes!("../../assets/monkey.obj");
            cursor.write_all(model_bytes).unwrap();
